...
<section class="layui-container wrapper">
    ...
    <div class="details-info layui-pull-right layui-col-md5 ">
        ...
        <div class="order-btn-container">
            ...
            <hr>
            <button class="shoucang-btn">收藏该房子</button>
        </div>
    </div>
...
<script>
    layui.use(['element', 'carousel', 'layer','form'], function () {
        ...
        $(".shoucang-btn").click(function(){
        	...
        	$.post("addshoucang",{id:$(".HID").val()},function(data){
        		if(data=="OK"){
    				layer.alert("恭喜你，收藏成功！",{icon:1});
    				$(".shoucang-btn").addClass("layui-btn-disabled");
    				$(".shoucang-btn").html("你已成功收藏");
    				$(".shoucang-btn").off("click");
    			}else if(data=="HAS"){
    				layer.alert("抱歉，该房您已经收藏过！",{icon:1}); 
    				$(".shoucang-btn").addClass("layui-btn-disabled");
    				$(".shoucang-btn").html("你已成功收藏");
    				$(".shoucang-btn").off("click");
    			}
    			else if(data=="LOGIN"){
    				layer.alert("抱歉，您还没有登录！",{icon:1}); 
    			}
        	});
        });
